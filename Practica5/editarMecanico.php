...
<body>
    ...
    <div id="formulario">
        ...
        <form action="generarCambiosMecanico.php" method="post">
            <table>
                <tr>
                    <td><input type="text" name="cedula" value="<?=$cedula?>"  style="visibility:hidden" id="datosTXT"> DATOS DEL MECÁNICO/A</td>
        ...
        <a  href="listaMecanico.php"> <button class="btn btn-light botones">Volver</button></a>
